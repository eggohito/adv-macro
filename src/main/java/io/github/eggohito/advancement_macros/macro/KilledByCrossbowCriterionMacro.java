...
public class KilledByCrossbowCriterionMacro extends Macro {
    ...
    public static final String PIERCED_KILLED_ENTITIES_KEY_FIELD = "pierced_killed_entities";
    ...
    public KilledByCrossbowCriterionMacro(String piercedKilledEntitiesKey) {
        super(Criteria.KILLED_BY_CROSSBOW.getId());
    ...
    public static Pair<Identifier, Type> getFactory() {
        return new Pair<>(Criteria.KILLED_BY_CROSSBOW.getId(), () -> CODEC);
    }
